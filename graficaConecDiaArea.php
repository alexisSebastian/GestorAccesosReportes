...
<body>
    ...
    <header>
        <!-- -------------Manú dropdown web-------------------- -->
        <ul id="dropdown1" class="dropdown-content.php">
            <li><a href="detalleUsuariosFirmadosDia.php">Detalle de usuarios firmados del día</a></li>
            <li class="divider"></li>
            <li><a href="detalleConexionesDia.php">Detalle de conexiones del día</a></li>
        </ul>
                        ...
                        <div class="card-panel">
                            <div class="row">
                                <div class="col s12 center">
                                    <h5>Distribución de conexiones del día por área</h5>
                                </div>    
                            </div>
                             <li class="divider"></li>
                            <!-- <div class="row"> -->
                            <div class="row" id="piechart_3d" style="width: 950px; height: 400px;"></div>
                            <!-- </div> -->
                        </div>
                    </div>
                </div>
